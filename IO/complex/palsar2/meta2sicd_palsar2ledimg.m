...
coords_az_m = linspace(-double(sicd_meta.ImageData.SCPPixel.Col) * sicd_meta.Grid.Col.SS,...
    double(img_meta.num_lines-sicd_meta.ImageData.SCPPixel.Col) * ...
    sicd_meta.Grid.Col.SS,grid_samples);
coords_rg_m = linspace(-double(sicd_meta.ImageData.SCPPixel.Row) * sicd_meta.Grid.Row.SS,...
    double(img_meta.num_pixels-sicd_meta.ImageData.SCPPixel.Row) * ...
    sicd_meta.Grid.Row.SS, grid_samples);
